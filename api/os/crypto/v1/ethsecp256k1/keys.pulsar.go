...
func init() {
	file_os_crypto_v1_ethsecp256k1_keys_proto_init()
	md_PubKey = File_os_crypto_v1_ethsecp256k1_keys_proto.Messages().ByName("PubKey")
...
func (x *PubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_os_crypto_v1_ethsecp256k1_keys_proto_msgTypes[0]
...
func (x *fastReflection_PubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "os.crypto.v1.ethsecp256k1.PubKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.crypto.v1.ethsecp256k1.PubKey"))
		}
		panic(fmt.Errorf("message os.crypto.v1.ethsecp256k1.PubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message os.crypto.v1.ethsecp256k1.PubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "os.crypto.v1.ethsecp256k1.PubKey.key":
		panic(fmt.Errorf("field key of message os.crypto.v1.ethsecp256k1.PubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.crypto.v1.ethsecp256k1.PubKey"))
		}
...
func (x *fastReflection_PubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in os.crypto.v1.ethsecp256k1.PubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_os_crypto_v1_ethsecp256k1_keys_proto_init()
	md_PrivKey = File_os_crypto_v1_ethsecp256k1_keys_proto.Messages().ByName("PrivKey")
...
func (x *PrivKey) slowProtoReflect() protoreflect.Message {
	mi := &file_os_crypto_v1_ethsecp256k1_keys_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_PrivKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "os.crypto.v1.ethsecp256k1.PrivKey.key":
		return len(x.Key) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.crypto.v1.ethsecp256k1.PrivKey"))
		}
		panic(fmt.Errorf("message os.crypto.v1.ethsecp256k1.PrivKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message os.crypto.v1.ethsecp256k1.PrivKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PrivKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "os.crypto.v1.ethsecp256k1.PrivKey.key":
		panic(fmt.Errorf("field key of message os.crypto.v1.ethsecp256k1.PrivKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.crypto.v1.ethsecp256k1.PrivKey"))
		}
...
func (x *fastReflection_PrivKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in os.crypto.v1.ethsecp256k1.PrivKey", d.FullName()))
	}
	panic("unreachable")
}
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescGZIP(), []int{0}
}
...
func (*PrivKey) Descriptor() ([]byte, []int) {
	return file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescGZIP(), []int{1}
}
...
var File_os_crypto_v1_ethsecp256k1_keys_proto protoreflect.FileDescriptor

var file_os_crypto_v1_ethsecp256k1_keys_proto_rawDesc = []byte{
	,
}

var (
	file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescOnce sync.Once
	file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescData = file_os_crypto_v1_ethsecp256k1_keys_proto_rawDesc
)

func file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescGZIP() []byte {
	file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescOnce.Do(func() {
		file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescData)
	})
	return file_os_crypto_v1_ethsecp256k1_keys_proto_rawDescData
}

var file_os_crypto_v1_ethsecp256k1_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_os_crypto_v1_ethsecp256k1_keys_proto_goTypes = []interface{}{
	(*PubKey)(nil),  // 0: os.crypto.v1.ethsecp256k1.PubKey
	(*PrivKey)(nil), // 1: os.crypto.v1.ethsecp256k1.PrivKey
}
var file_os_crypto_v1_ethsecp256k1_keys_proto_depIdxs = []int32{
...
func init() { file_os_crypto_v1_ethsecp256k1_keys_proto_init() }
func file_os_crypto_v1_ethsecp256k1_keys_proto_init() {
	if File_os_crypto_v1_ethsecp256k1_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_os_crypto_v1_ethsecp256k1_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PubKey); i {
			case 0:
				return &v.state
			case 1:
		...
		file_os_crypto_v1_ethsecp256k1_keys_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_os_crypto_v1_ethsecp256k1_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_os_crypto_v1_ethsecp256k1_keys_proto_goTypes,
		DependencyIndexes: file_os_crypto_v1_ethsecp256k1_keys_proto_depIdxs,
		MessageInfos:      file_os_crypto_v1_ethsecp256k1_keys_proto_msgTypes,
	}.Build()
	File_os_crypto_v1_ethsecp256k1_keys_proto = out.File
	file_os_crypto_v1_ethsecp256k1_keys_proto_rawDesc = nil
	file_os_crypto_v1_ethsecp256k1_keys_proto_goTypes = nil
	file_os_crypto_v1_ethsecp256k1_keys_proto_depIdxs = nil
}

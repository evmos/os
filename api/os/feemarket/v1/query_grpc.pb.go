...
const (
	Query_Params_FullMethodName   = "/os.feemarket.v1.Query/Params"
	Query_BaseFee_FullMethodName  = "/os.feemarket.v1.Query/BaseFee"
	Query_BlockGas_FullMethodName = "/os.feemarket.v1.Query/BlockGas"
)

...
const (
	Query_TokenPairs_FullMethodName = "/os.erc20.v1.Query/TokenPairs"
	Query_TokenPair_FullMethodName  = "/os.erc20.v1.Query/TokenPair"
	Query_Params_FullMethodName     = "/os.erc20.v1.Query/Params"
)

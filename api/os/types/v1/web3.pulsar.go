...
func init() {
	file_os_types_v1_web3_proto_init()
	md_ExtensionOptionsWeb3Tx = File_os_types_v1_web3_proto.Messages().ByName("ExtensionOptionsWeb3Tx")
...
func (x *ExtensionOptionsWeb3Tx) slowProtoReflect() protoreflect.Message {
	mi := &file_os_types_v1_web3_proto_msgTypes[0]
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "os.types.v1.ExtensionOptionsWeb3Tx.typed_data_chain_id":
		return x.TypedDataChainId != uint64(0)
	case "os.types.v1.ExtensionOptionsWeb3Tx.fee_payer":
		return x.FeePayer != ""
	case "os.types.v1.ExtensionOptionsWeb3Tx.fee_payer_sig":
		return len(x.FeePayerSig) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.types.v1.ExtensionOptionsWeb3Tx"))
		}
		panic(fmt.Errorf("message os.types.v1.ExtensionOptionsWeb3Tx does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message os.types.v1.ExtensionOptionsWeb3Tx does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "os.types.v1.ExtensionOptionsWeb3Tx.typed_data_chain_id":
		panic(fmt.Errorf("field typed_data_chain_id of message os.types.v1.ExtensionOptionsWeb3Tx is not mutable"))
	case "os.types.v1.ExtensionOptionsWeb3Tx.fee_payer":
		panic(fmt.Errorf("field fee_payer of message os.types.v1.ExtensionOptionsWeb3Tx is not mutable"))
	case "os.types.v1.ExtensionOptionsWeb3Tx.fee_payer_sig":
		panic(fmt.Errorf("field fee_payer_sig of message os.types.v1.ExtensionOptionsWeb3Tx is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: os.types.v1.ExtensionOptionsWeb3Tx"))
		}
...
func (x *fastReflection_ExtensionOptionsWeb3Tx) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in os.types.v1.ExtensionOptionsWeb3Tx", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ExtensionOptionsWeb3Tx) Descriptor() ([]byte, []int) {
	return file_os_types_v1_web3_proto_rawDescGZIP(), []int{0}
}
...
var File_os_types_v1_web3_proto protoreflect.FileDescriptor

var file_os_types_v1_web3_proto_rawDesc = []byte{
	,
}

var (
	file_os_types_v1_web3_proto_rawDescOnce sync.Once
	file_os_types_v1_web3_proto_rawDescData = file_os_types_v1_web3_proto_rawDesc
)

func file_os_types_v1_web3_proto_rawDescGZIP() []byte {
	file_os_types_v1_web3_proto_rawDescOnce.Do(func() {
		file_os_types_v1_web3_proto_rawDescData = protoimpl.X.CompressGZIP(file_os_types_v1_web3_proto_rawDescData)
	})
	return file_os_types_v1_web3_proto_rawDescData
}

var file_os_types_v1_web3_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_os_types_v1_web3_proto_goTypes = []interface{}{
	(*ExtensionOptionsWeb3Tx)(nil), // 0: os.types.v1.ExtensionOptionsWeb3Tx
}
var file_os_types_v1_web3_proto_depIdxs = []int32{
...
func init() { file_os_types_v1_web3_proto_init() }
func file_os_types_v1_web3_proto_init() {
	if File_os_types_v1_web3_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_os_types_v1_web3_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_os_types_v1_web3_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_os_types_v1_web3_proto_goTypes,
		DependencyIndexes: file_os_types_v1_web3_proto_depIdxs,
		MessageInfos:      file_os_types_v1_web3_proto_msgTypes,
	}.Build()
	File_os_types_v1_web3_proto = out.File
	file_os_types_v1_web3_proto_rawDesc = nil
	file_os_types_v1_web3_proto_goTypes = nil
	file_os_types_v1_web3_proto_depIdxs = nil
}

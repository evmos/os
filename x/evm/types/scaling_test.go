...
func TestMustConvertEvmCoinTo18Decimals(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			evmCoinInfo: evmtypes.EvmCoinInfo{Denom: exampleDenom, Decimals: evmtypes.EighteenDecimals},
			coin:        baseCoinZero,
			expPanic:    false,
		...
		},
		{
			...
			evmCoinInfo: evmtypes.EvmCoinInfo{Denom: exampleDenom, Decimals: evmtypes.SixDecimals},
			coin:        baseCoinZero,
			expPanic:    false,
			expCoin:     baseCoinZero,
		},

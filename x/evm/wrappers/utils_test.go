...
func TestMustConvertEvmCoinTo18Decimals(t *testing.T) {
	baseCoinZero := sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(0)}
	...
	testCases := []struct {
	...
	}{
		{
			...
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.EighteenDecimals},
			coin:        baseCoinZero,
			expPanic:    false,
		...
		},
		{
			...
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.SixDecimals},
			coin:        baseCoinZero,
			expPanic:    false,
			expCoin:     baseCoinZero,
		},
		{
			...
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.EighteenDecimals},
			coin:        sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(10)},
			expPanic:    false,
			expCoin:     sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(10)},
		},
		{
			name:        "pass - conversion with 6 decimals",
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.SixDecimals},
			coin:        sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(1)},
			expPanic:    false,
			expCoin:     sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(1e12)},
		},
		{
...
func TestConvertEvmCoinFrom18Decimals(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:        "pass - no conversion with 18 decimals",
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.EighteenDecimals}, coin: sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(10)}, expErr: false,
			expCoin: sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(10)},
		},
		{
			name:        "pass - conversion with 6 decimals",
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.SixDecimals},
			coin:        sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(1e12)},
			expErr:      false,
			expCoin:     sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(1)},
		},
		{
			name:        "pass - conversion with amount less than conversion factor",
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.SixDecimals},
			coin:        sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(1e11)},
			expErr:      false,
			expCoin:     baseCoinZero,
		},
		{
...
func TestConvertCoinsFrom18Decimals(t *testing.T) {
	...
	baseCoin := sdk.Coin{Denom: exampleDenom, Amount: math.NewInt(10)}
	...
	testCases := []struct {
		...
		},
		{
			...
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.SixDecimals},
			coins:       sdk.Coins{baseCoin},
			expCoins:    sdk.Coins{sdk.Coin{Denom: exampleDenom, Amount: baseCoin.Amount.QuoRaw(1e12)}},
		},
		{
		...
		},
		{
			...
			evmCoinInfo: config.EvmCoinInfo{Denom: exampleDenom, Decimals: config.SixDecimals},
			coins:       sdk.Coins{nonBaseCoin, baseCoin},
			expCoins:    sdk.Coins{nonBaseCoin, sdk.Coin{Denom: exampleDenom, Amount: baseCoin.Amount.QuoRaw(1e12)}},
		},
	}
...
func TestZeroExtraDecimalsBigInt(t *testing.T) {
	...
	for _, cfg := range []config.EvmCoinInfo{
		{Denom: testconstants.ExampleAttoDenom, Decimals: config.SixDecimals},
		{Denom: testconstants.ExampleAttoDenom, Decimals: config.EighteenDecimals},
	} {
		for _, tc := range testCases {
